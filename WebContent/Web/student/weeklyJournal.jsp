...
<body>
	...
	<br>
	<div class="container">
		<form action="JournalAction_SaveJournal.action" method="post"
			class="form-horizontal m-t" id="commentForm" novalidate="novalidate" onsubmit="return CheckJournalPost()">
			...
			<table>
				<tr>
					...
					<td width="130px" align="right"><button type="button"
							class="btn btn-primary btn2" onclick="saveDraft()">保存为草稿</button></td>
	...
	function saveDraft() {
		...
		if(content!=""){
			$.ajax({
				...
				url : 'JournalAction_SaveDraft.action',
				data : {
