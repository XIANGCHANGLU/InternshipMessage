...
<body>
	...
	<div class="search-wrap">
		<div class="search-content">
			<form action="AdminAction_seacherCmpWithStu.action" method="get">
	...
	<div class="page">
		<s:url id="url_pre" value="AdminAction_seacherCmpWithStu.action">
			<s:param name="pageNow" value="pageNow-1"></s:param>
			<s:param name="searchsort" value="searchsort"></s:param>
			<s:param name="searname" value="searname"></s:param>
		</s:url>

		<s:url id="url_next" value="AdminAction_seacherCmpWithStu.action">
			<s:param name="pageNow" value="pageNow+1"></s:param>
			<s:param name="searchsort" value="searchsort"></s:param>
			<s:param name="searname" value="searname"></s:param>
		</s:url>
		<s:url id="url" value="AdminAction_seacherCmpWithStu.action">
				<s:param name="pageNow" value="1" />
				<s:param name="searchsort" value="searchsort"></s:param>
			<s:param name="searname" value="searname"></s:param>
		</s:url>
			<s:url id="last_url" value="AdminAction_seacherCmpWithStu.action">
